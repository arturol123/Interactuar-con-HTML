...
const TituloH4 = document.getElementById("PromocionEspecial")
TituloH1.innerText = "Vehiculos"
TituloH3[2].innerText = "Cotización"

function Promoción (){
    TituloH4.innerText = "FELICIDADES, YA QUE SU ENGANCHE ES MAYOR A 50%, USTED A SIDO ACREDOR A UN 10% DE DESCUENTO ADICIONAL"
...
//************************Introducir Enganche inicial*********************** *//
 ...
 do {
    ...
    else if (EngancheInicial >=50 && EngancheInicial <= 99){
        Promoción ()
    }
